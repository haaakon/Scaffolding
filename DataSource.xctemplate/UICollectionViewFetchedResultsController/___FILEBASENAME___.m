...
@interface ___FILEBASENAMEASIDENTIFIER___()<NSFetchedResultsControllerDelegate, UICollectionViewDataSource>
...
#warning Unimplemented fetched results controller
    ...
    NSManagedObjectContext *managedObjectContext = <#NSManagedObjectContext #>;
